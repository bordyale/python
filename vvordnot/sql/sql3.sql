SELECT ORDER_ID, SHIP_BEFORE_DATE, NAME, QUANTITY_SHIPPABLE, WEIGHT, QUANTITY, PARTNER_NAME, ORDER_WEIGHT
FROM    
    (SELECT OS.ORDER_ID, PART.NAME AS PARTNER_NAME, OH.SHIP_BEFORE_DATE, OH.ORDER_WEIGHT, OS.ORDER_ITEM_SEQ_ID, OS.PRODUCT_ID, PR.NAME, PR.WEIGHT, OS.QUANTITY, OS.QUANTITY_SHIPPED, OS.QUANTITY - OS.QUANTITY_SHIPPED AS QUANTITY_SHIPPABLE
    FROM
